...
const UserProfile = () => {
  ...
  const [profileUpdate, setProfileUpdate] = useState({ selectedType: '', selectedAvtaar: ''})
  ...
  const handleProfileUpdate = async () => {
    try {
        ...
        const response = await axios.post(`${import.meta.env.VITE_API_URL}/users/update-profile-picture`, payloadBody, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`,
  ...
  return (
    <div className='flex flex-col gap-4 bg-slate-200 h-full'>
      ...
      {profilePicUpdate && (
        <Dialog fullWidth maxWidth='sm' open={profilePicUpdate} onClose={() => setProfilePicUpdate(false)}>
          ...
          <DialogContent>
            <div className='flex flex-col gap-5 justify-center items-center'>
              <div className='flex items-center gap-8 justify-around'>
                ...
                <div className='w-36 h-36'>
                  {profileUpdate?.selectedType?.length > 0 ? <img
              ...
              <div className='w-full'>
                <Label>Type</Label>
                <Select onValueChange={(e) => setProfileUpdate((prev) => { return { ...prev, selectedType: e}})}>
              ...
              <div className='w-full'>
                <Label>Avataar</Label>
                <Select onValueChange={(e) => setProfileUpdate((prev) => { return { ...prev, selectedAvtaar: e}})}>
                  <SelectTrigger className='w-full'>
