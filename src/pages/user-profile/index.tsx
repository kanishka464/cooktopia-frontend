        ...
        <div className="flex flex-col gap-4 bg-slate-200 h-full">
                ...
                <div className="flex w-full justify-between items-center py-4 px-8">
                    <div className="flex items-center gap-4">
                        <div className="bg-slate-400 h-24 w-24 rounded-full">
                            <img src={`https://api.dicebear.com/9.x/avataaars/svg?seed=${localStorage.getItem("userImage")}&radius=50&backgroundColor=65c9ff,b6e3f4,ffdfbf,ffd5dc,d1d4f9,c0aede&backgroundType=gradientLinear,solid`}/>
                        </div>

                        <div className="flex flex-col gap-4 justify-between">
                            <div className="flex flex-col">
                                <div className="text-xl font-bold">{profileDetails?.name || 'Developer'}</div>
                            ...
                            <div className="flex gap-8 items-center">
                                <div className="flex flex-col items-center">
                                    <div className="font-bold text-sm">245</div>
                                    <div className="text-sm font-light">Recipes</div>
                                </div>
                                <div className="flex flex-col items-center">
                                    <div className="font-bold text-sm">{profileDetails?.followers?.length}</div>
                                    <div className="text-sm font-light">Followers</div>
                                </div>
                                <div className="flex flex-col items-center">
                                    <div className="font-bold text-sm">{profileDetails?.following?.length}</div>
            ...
            <div className="flex mx-auto w-[97%] bg-white rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                <div className="flex w-full items-center py-2 px-8">
                    {
                        ["My Recipes", "Liked", "Following", "Followers"].map((item, index) => (
                            <div 
                                key={index} 
